...
def plot_rect3d_on_img(img,
                       ...
                       rect_corners,
                       color=(0, 255, 0),
                       thickness=1, labels=None, scores=None):
    ...
    for i in range(num_rects):
        ...
        cv2.putText(img, '{} {:.3f}'.format(label, score), (corners[0, 0], corners[0, 1]-1), cv2.FONT_HERSHEY_SIMPLEX, 0.45, color_label)
        for start, end in line_indices:
            # if start==0 & end==3:
            #         cv2.puttext(img, '{} {:.3f}'.format(label,score), ())
...
def draw_lidar_bbox3d_on_img(bboxes3d,
                             ...
                             img_metas,
                             color=(0, 255, 0),
                             thickness=1, labels_3d=None, scores_3d=None):
    ...
    # print(plot_rect3d_on_img(img, num_bbox, imgfov_pts_2d, color, thickness))
    return plot_rect3d_on_img(img, num_bbox, imgfov_pts_2d, color, thickness, labels=labels_3d, scores=scores_3d)
